...
/// Home screen showing all media items with notes
/// ViewModel is always injected via init for testability
struct LibraryView: View {
    let viewModel: any LibraryViewModelProtocol
    @State var showingAddNote: Bool = false
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                case .ready(let items) where items.isEmpty || viewModel.filteredItems.isEmpty && viewModel.selectedFilter == nil:
                    emptyStateView
            ...
            .sheet(isPresented: $showingAddNote) {
                DependencyProvider.shared.dependencies.makeAddNoteView(preselectedMedia: nil)
            }
            .onAppear {
                Task {
    ...
    private var emptyStateView: some View {
        VStack(spacing: Theme.spacingLG) {
            ...
            VStack(spacing: Theme.spacingSM) {
                ...
                Text("Start capturing your thoughts about\nthe media you consume")
...
#Preview {
    ...
    return dependencies.makeLibraryView()
}
